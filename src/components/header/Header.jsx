...
const Header = () => {
  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300 ease-in-out">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 items-center flex justify-between h-16 md:h-20">
        {/* Logo/Name */}
        <motion.div
        ...
        >
          <div
            className="h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100 flex items-center justify-center
          text-purple-600 text-xl font-bold mr-3"
          >
            H
          </div>
        ...
        {/* Desktop Navigation */}
        <nav className="lg:flex hidden space-x-8 text-white">
          {["Home", "About", "Projects", "Experience", "Contact"].map(
            (item, index) => (
              ...
              >
                {item}
                <span
                  className="absolute bottom-0 left-0 w-0 h-0.5 bg-violet-600
        ...
        <div className="md:flex hidden items-center space-x-4 ">
          ...
          to-gray-100 text-violet-700 font-bold hover:from-violet-700
          hover:to-purple-700 hover:text-white transition-colors duration-500"
          >
            Hire Me
          </motion.button>
        </div>
      ...
      <AnimatePresence>
        ...
        max-w-md p-6"
            >
              ...
              hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-klg hover:shadow-violet-600/50"
                >
                  Send Message
                </motion.button>
              </form>
